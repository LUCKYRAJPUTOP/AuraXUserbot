# Credit To @AuraX_Owner . Keep credit if you are going to edit it. Join @AuraXUserbot
...
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        ...
        await edit_or_reply(event, "`Testing Äµråxßð†`")
        ...
        await edit_or_reply(event, 
            "Your[Äµråxßð†](https:/t.me/AuraXUserbot) is working Fine...\n       Join @AuraXSupport For Any Help......"
        )
