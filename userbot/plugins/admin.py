...
async def promote(promt):
    ...
    try:
        ...
        await AuraXevent.edit("`Promoted Successfully! Pawrii kro benchooo`")
...
async def demote(dmod):
    ...
    try:
        ...
        await AuraXevent.edit(NO_PERM)
        return
    await AuraXevent.edit("`Demoted retard Successfully..... Chal Nikal`")
    if BOTLOG:
...
async def ban(bon):
    ...
    if not user:
        return
    AuraXevent = await edit_or_reply(bon, "`Banning this Chutiya`")
    try:
...
async def nothanos(unbon):
    ...
    try:
        ...
        await AuraXevent.edit("```Unbanned Successfully. Granting another chance.```")
        if BOTLOG:
        ...
        await AuraXevent.edit("`Uh oh my unban logic broke!`")
